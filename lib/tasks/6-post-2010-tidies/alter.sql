...
update political_parties set disclaimer = 'Figures presented for Labour include candidates certified by both the Labour and the Co-operative parties.' where id = 3;
