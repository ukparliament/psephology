...
--
-- Name: maiden_speeches fk_adjunct_political_party; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maiden_speeches
    ADD CONSTRAINT fk_adjunct_political_party FOREIGN KEY (adjunct_political_party_id) REFERENCES public.political_parties(id);
...
--
-- Name: maiden_speeches fk_main_political_party; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.maiden_speeches
    ADD CONSTRAINT fk_main_political_party FOREIGN KEY (main_political_party_id) REFERENCES public.political_parties(id);
