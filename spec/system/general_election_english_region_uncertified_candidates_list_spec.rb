...
describe "Test for checking page load and data accuracy of general_election/:general_election/countries/2/english-regions/:english-region/uncertified-candidates 2024 07 04 GE", type: :system do
	...
	let(:first_line_of_results_table) {['Hove and Portslade',	'MARAH, Tanushka',	'Independent',	'3,048',	'5.9%',	'5th']}
	
	it 'loads general-election/:general-election/countries/2/english-regions/:english-region/uncertified-candidates based on 2024 07 04 GE' do
		...
		#pass to general_election_list_path
			visit general_election_english_region_uncertified_candidacy_list_path(generalelection, country, englishregion)
		...
		#check content on page suggests correct page?
			...
			expect(page).to have_content("#{englishregionName}, #{countryName} - non-party candidates")
