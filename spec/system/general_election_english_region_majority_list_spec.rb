...
describe "Test for checking page load and data accuracy of general_election/:general_election/countries/2/english-regions/:english-region/majority 2024 07 04 GE", type: :system do
	...
	let(:first_line_of_results_table) {['Hove and Portslade','KYLE, Peter',	'Lab', '51,909', '19,791',	'38.1%']}

	it 'loads general-election/:general-election/countries/2/english-regions/:english-region/majority based on 2024 07 04 GE' do
		...
		#pass to general_election_list_path
			visit general_election_english_region_majority_list_path(generalelection, country, englishregion)
		...
		#check content on page suggests correct page?
			...
			expect(page).to have_content("#{englishregionName}, #{countryName} - by majority")
