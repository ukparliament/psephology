...
describe "Test for checking page load and data accuracy of general_election/:general_election/political-parties/:political-party/election/won 2024 07 04 GE", type: :system do
	...
	#headers : Constituency, Candidate, Standing as, Votes, Vote share, Position
	let(:first_line_of_results_table) {['Chorley','HOYLE, Lindsay', 'Commons Speaker', '25,238', '74.3%', '1st']}
						

	it 'loads general-election/:general-election/uncertified-candidacies based on 2024 07 04 GE' do
