require 'rails_helper'
	...
	it "loads the correct page general-elections/:general-election/poltical-parties" do
			...
			visit general_election_party_list_path(generalelection)
			...
			expect(page).to have_content("By party")
