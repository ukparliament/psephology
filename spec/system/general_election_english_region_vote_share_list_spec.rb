...
describe "Test for checking page load and data accuracy of general_election/:general_election/countries/2/english-regions/:english-region/vote-share 2024 07 04 GE", type: :system do
	...
	let(:first_line_of_results_table) {['1',	'Brighton Pavilion','BERRY, Siân',	'Green',	'55.0%']}
	...
	it 'loads general-election/:general-election/countries/2/english-regions/:english-region/vote-share based on 2024 07 04 GE' do
		...
		#pass to general_election_list_path
			visit general_election_english_region_vote_share_list_path(generalelection, country, englishregion)
		...
		#check content on page suggests correct page?
			...
			expect(page).to have_content("#{englishregionName}, #{countryName} - by vote share")
