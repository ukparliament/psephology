...
describe "Test for checking page load and data accuracy of general_election/:general_election/countries/2/english-regions/:english-region/political-parties/:political-party/won 2024 07 04 GE", type: :system do
	...
	let(:first_line_of_results_table) {['Arundel and South Downs',	'GRIFFITH, Andrew',	'77,969',	'70.2%',	'22,001',	'40.2%',	'-20.2%',	'12,134']}
	
	it 'loads general-election/:general-election/countries/2/english-regions/:english-region/political-parties/:political-party/won based on 2024 07 04 GE' do
		...
		#pass to general_election_list_path
			visit general_election_english_region_party_election_won_path(generalelection, country, englishregion, politicalparty)
		...
		#check content on page suggests correct page?
			...
			expect(page).to have_content("#{englishregionName}, #{countryName} - Elections won by #{politicalpartyName}")
