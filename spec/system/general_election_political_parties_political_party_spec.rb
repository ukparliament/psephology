...
describe "Test for checking page load and data accuracy of general_election/:general_election/vote-share 2024 07 04 GE", type: :system do
	...
	let(:first_line_of_results_table) {[ '1', 'Chorley', 'HOYLE, Lindsay', 'Spk', '74.3%' ]}


	it 'loads general-election/:general-election/political-patries/:political-party based on 2024 07 04 GE ' do
		...
		#get the political party
			...
			visit general_election_party_show_path(generalelection,politicalparty)
	...
	#only one test as just loads page to see links eo elections won and elections contested.
