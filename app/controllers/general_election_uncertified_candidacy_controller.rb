class GeneralElectionUncertifiedCandidacyController < ApplicationController
  ...
  def index
    ...
    @description = "Results for a general election to the Parliament of the United Kingdom on #{@general_election.polling_on.strftime( $DATE_DISPLAY_FORMAT )} listing candidates not certified by a political party."
